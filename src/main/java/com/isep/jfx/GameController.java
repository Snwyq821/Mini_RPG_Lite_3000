...
public class GameController implements Initializable
{
    ...
    public void onButtonClick() throws InterruptedException
    {
        ...
        if (currentHeroInList == 0) {
            for (Enemy e : game.enemyList)
            {
                ...
                {
                    alertPopup("Game Over...", "You lost... It's so sad that I will now close this game...");
                }
                else
                {
    ...
    public void onAttackButtonClick() throws InterruptedException {
        ...
        String battleLog = currentHeroLabel.getText() + " inflicted " + game.party.get(currentHeroInList).getWeaponDamage() + " damage !";
        if(!game.enemyList.get(selection).isAlive())
        {
            battleLog = battleLog + " You defeated an enemy.";
        ...
        {
            alertPopup("Victory !", "You defeated all enemies ! Now the game will autodestruct...");
        }
